    ...
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <div class="row pull-left">
                <div class="col-sm-4">
                    <a href="{{ route('backend.servicos.create') }}"
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="{{ route('backend.servicos.edit', ['id' => $servico->id])}}" class="dropdown-item">
                                            Editar
                                        </a>


                                        <a href="/backend/servicos/{{$servico->id}}/destroy" class="dropdown-item">
                                            Deletar
                                        </a>
