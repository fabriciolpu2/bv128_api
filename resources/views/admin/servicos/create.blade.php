    ...
    <div class="row m-t-50">
        <div class="col-lg-12">
            <div class="card-box">
                ...
                @if(isset($servico->id))
                    <form  method="POST" enctype="multipart/form-data" action="{{route('servicos.update', $servico->id)}}">
                @else
                    <form method="POST" class="form-horizontal" action="{{ route('servicos.store') }}">
                @endif
                {{ csrf_field() }}
                    ...
                    <div class="form-group row text-center m-t-10">
                        <div class="col-12">
                            ...
                            <a href="{{route('servicos.index')}}" class="btn btn-dark btn-block">Go Back</a>
                        </div>
                    </div>
                </form>
            </div>
