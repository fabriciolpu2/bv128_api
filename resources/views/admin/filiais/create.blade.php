    ...
    <div class="row m-t-50">
        <div class="col-lg-12">
            <div class="card-box">
                ...
                @if(isset($filial->id))
                    <form  method="POST" enctype="multipart/form-data" action="{{route('filiais.update', $filial->id)}}">
                @else
                    <form method="POST" enctype="multipart/form-data" class="form-horizontal" action="{{ route('filiais.store') }}">
                @endif
                {{ csrf_field() }}
                    ...
                    <div class="form-group row text-center m-t-10">
                        <div class="col-12">
                            ...
                            <a href="{{route('filiais.index')}}" class="btn btn-dark btn-block">Go Back</a>
                        </div>
                    </div>
                </form>
            </div>
