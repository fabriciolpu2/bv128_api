        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-md-8 col-lg-7">
                <div class="hero-content-left text-white text-center mt-5 ptb-100">
                    ...
                    <p class="lead text-uppercase">Em <span class="text-black font-weight-800">Desenvolvimento de Jogos</span>
                        & <span class="text-black font-weight-800">Modelagem 3D</span></p>
