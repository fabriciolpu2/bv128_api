...
<div class="wrapper-page account-page-full">
                ...
                <div class="card-box p-5">
                    ...
                    <div class="account-content text-center">
                        <svg version="1.1" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
                                ...
                                {{-- <i class="fa fa-send fa-4x text-primary"></i> --}}

                        <p class="text-muted font-14 mt-2"> An email has been sent to<b>{{$email}}</b>.
                            Please check in your inbox and click on the link to reset your password.
                        </p>

                        <a href="/" class="btn btn-md btn-dark btn-block btn-custom waves-effect waves-light mt-3">Back to site</a>
                    </div>
    ...
    <div class="m-t-40 text-center">
        <p class="account-copyright"><?= date('Y') ?> © Amplomed.com</p>
    </div>
