                            ...
                            <div class="col-md-6">
                                <div class="card card-blog card-plain">
                                    ...
                                    <div class="card-footer text-left">
                                        <div class="author">
                                            <button class="btn btn-success btn-round btn-simple" data-toggle="modal"
                                                data-target="#myModal">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p> Essa é a nossa primeira aula. Segue os links dos materiais necessários para melhor
                                proveito! :)
                            </p>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=fcfqom5nv" width="100%"
                                height="200" seamless="seamless" scrolling="no" frameBorder="0" allowFullScreen>
                            </iframe>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
